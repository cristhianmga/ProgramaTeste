...
//BANCO DE DADOS
string mySqlConnection = builder.Configuration.GetConnectionString("BD_DEV");
builder.Services.AddDbContext<TesteContext>(options => options.UseSqlServer(mySqlConnection));
